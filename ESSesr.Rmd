...
```{r, echo = FALSE, out.width="75%", fig.align="center", fig.cap="Eastern Scotian Shelf Management area"}
#integrate new map
...
```{r,fig.show='hold',fig.align="center", echo = FALSE,fig.width = 5, out.width="50%", fig.cap="The annual sea-surface-temperature normalized anomaly for NAFO regions within the ESS derived from satellite imagery compared to their long-term monthly means. Horizontal dashed lines represent plus or minus 0.5 SD for the 1991-2020 period. Regime shift analysis results from running the method forwards and backwards on the time series depicted by the blue and red horizontal lines, respectively. "}
...
```{r,fig.align="center", echo = FALSE, fig.width = 5,fig.pos='H', out.width="60%", fig.cap="Time series of July bottom-temperature anomalies (thin lines with circles) and five-year-running-mean filtered series (heavy line) for NAFO regions within the ESS. The solid horizontal line is the 1991-2020 mean and dashed lines represent ±0.5 SD. Regime shift analysis results from running the method forwards and backwards on the time series depicted by the blue and red horizontal lines, respectively."}
...
```{r, fig.align="center", echo = FALSE, fig.pos='H',fig.cap="Sea Surface Temperature and Bottom temperature from fixed stations for 4Vn, 4Vs, 4W. Dotted lines denote the long-term mean."}
...
- SST in th Eastern Scotian Shelf area between 2016-2020 is within the reference period mean (1991-2020), indicating average sea temperatures in the ESS over recent years. However bottom temperature in ESS has generally remained higher than average. 

### Dissolved Oxygen
```{r, fig.align="center", echo = FALSE,fig.width = 14, fig.pos='H',fig.cap="Dissolved oxygen (mmol/L) for the ESS. Dotted lines denote the long-term mean."}
dat.dir<-here::here("data")
...
po2_ess<-plot_indicator(ess_o2_annual, YEAR, mean_data, y_label= "ESS dissolved oxygen (mmol/L)") 
...
### Stratification
```{r, fig.align="center", echo = FALSE,fig.width = 14, fig.pos='H',fig.cap="Stratification for the ESS from 1970-2018. Dotted lines denote the long-term mean."}
dat.dir<-here::here("data")
...
### Salinity
```{r, fig.align="center", echo = FALSE,fig.width = 14, fig.pos='H',fig.cap="Salinity for the ESS from 1970-2018. Dotted lines denote the long-term mean."}
dat.dir<-here::here("data")
SSenv <- "SS_environmental_indicators.Rdata"
  load(file.path(dat.dir, SSenv))
...
Salinity<- SS_environmental_indicators |> 
  ...
  psal<-plot_indicator(Salinity, YEAR, Salinity, y_label="Salinity") 
...
- Fishing pressure on gadoids and forage fish have been below the long term mean since the 1990s. In contrast, fishing pressure on invertebrates has been close to the long term average in recent years.
...
### Bloom statistics
```{r fig.align="center", echo = FALSE,fig.width = 10, fig.height=10,fig.pos='H', fig.cap=" and Bloom statistics,for the ESS. Horizontal lines representent the mean +/- 1 sd. Purple, shaded areas are the latest 5 years of available data. "}
azmpdata::RemoteSensing_Annual_Broadscale
...
```{r fig.align="center", echo = FALSE,fig.width = 10, fig.height=10,fig.pos='H', fig.cap=" C.finmarchicus, and meso zooplankton biomass (dry weight), from NAFO regions within the ESS. Horizontal lines representent the mean +/- 1 sd. Purple, shaded areas are the latest 5 years of available data. "}
...
```
-2018 low values are due to lack of RV survey data for the ESS.
