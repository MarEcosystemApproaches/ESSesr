---
title: " 2025 Ecosystem Summary Report pilot for the Eastern Scotian Shelf (ESS)"
...
```
- SST and bottom temperature data are only available until 2020, and awaiting updates.
...
```{r fig.align="center", echo = FALSE,fig.pos='H',fig.width = 5, fig.height=3, fig.cap="Large fish indicator from RV survey data that has been corrected for catchability. Dashed lines represent the mean, solid green lines denote ± stanard deviation (SD). Purple, shaded areas are the latest 5 years of available data."}
dat.dir<-here::here("data")
eco_indicators<- "eco_indicators_esswss.Rdata"
  load(file.path(dat.dir, eco_indicators))
