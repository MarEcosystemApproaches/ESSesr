...
```{r, echo = FALSE, fig.align="center", fig.pos='H', fig.cap="Sea Surface Temperature from satellite and Bottom temperature from fixed stations for 4Vn, 4Vs, 4W. Dashed lines denote the long-term mean."}
...
```{r ,fig.align="center", echo = FALSE,fig.pos='H', fig.cap="Fishing Pressure (FP) calculated from DFO Summer Research Vessel survey. Data have been corrected for catchability with the exception of invertebrates. Dashed lines denote long-term means, solid green lines denote ± stanard deviation (SD) from the available timeseries. Purple, shaded areas represent the latest 5 years of available, robust data."}
...
```{r, fig.align="center", echo = FALSE,fig.width = 14, fig.height=10, fig.pos='H',fig.cap ="Shrimp Fishing Areas (red lines) and bathymetries for the ESS. Blue lines indicate depth > 75 fathoms (left), Black lines indicate depth > 100 fathoms (right)."}
dat.dir<-here::here("data")
bathy<- "bathy_sf.rda"
coast<-"coast_sf.rda"
...
### Bloom statistics
```{r fig.align="center", echo = FALSE,fig.width = 10, fig.height=10,fig.pos='H', fig.cap="Bloom statistics,for the ESS. Dashed lines representent the mean, solid green lines denote ± stanard deviation (SD) . Purple, shaded areas are the latest 5 years of available data. "}
azmpdata::RemoteSensing_Annual_Broadscale
...
```
- In the ESS bloom statistics are generally within the longterm mean range for 2020, and show no trend over time. 
...
- Forage fish have been relatively stable in the ESS with annual biomass within or above the longterm mean since the mid-1980s. In the last couple years forage fish biomass has been close to the longterm mean.
