---
title: " 2025 Ecosystem Summary Report pilot for ESS_v02"
...
The ESS area is strongly influenced by natural variability of the climate system (e.g., North Atlantic Oscillation) and, therefore, long-term monitoring is needed to determine how anthropogenic climate change is affecting ocean temperatures. 


### North Atlantic Oscillation Index
[Hebert et al. 2024](https://publications.gc.ca/collections/collection_2024/mpo-dfo/Fs97-18-380-eng.pdf) (see Section 2.1)

```{r ,fig.align="center", echo = FALSE,fig.pos='H', fig.width = 6, fig.height=3,fig.cap="The North Atlantic Oscillation (NAO) index, defined as the winter (December, January, February, March) 500 mb pressure Principal Component Analysis which is representative of the difference between the Icelandic low and Azores high. Climatological mean is shown as the dashed line, solid lines are ± standard deviation (SD)."}
...
```{r,fig.show='hold',fig.align="center", fig.pos='H', echo = FALSE, fig.cap="The annual sea-surface-temperature normalized anomaly for NAFO regions within the ESS derived from satellite imagery compared to their long-term monthly means. Horizontal solid lines represent ± stanard deviation (SD) for the 1991-2020 period. Regime shift analysis results from running the method forwards and backwards on the time series depicted by the blue and red horizontal lines, respectively. "}
...
```{r,fig.align="center", echo = FALSE, fig.pos='H', fig.cap="Time series of July bottom-temperature anomalies for NAFO regions within the ESS. The dashed horizontal line is the 1991-2020 mean and solid lines represent ± stanard deviation (SD). Regime shift analysis results from running the method forwards and backwards on the time series depicted by the blue and red horizontal lines, respectively."}
...
- The near-bottom temperature anomalies for 2023 showed a decreasing trends across NAFO 4Vn, 4Vs, and 4W areas. While the northern part of the ESS (NAFO 4Vn) is in a warmer bottom temperature regime since 2012, The southeast portion of the ESS (NAFO 4Vs) is in the normal range in 2022-2023.  On southwest portion of the ESS (NAFO 4W) bottom temperatures were showing cooling trends below normal for 2023. All regions show elevated bottom temperatures from years 2010-2021.


### Sea Surface Temperature (SST), Bottom Temperature
[Casault et al. 2020](https://casaultb.github.io/azmpdata/)
```{r, echo = FALSE, fig.align="center", fig.height=8,fig.width=10, fig.pos='H', fig.cap="Sea Surface Temperature from satellite and Bottom temperature from fixed stations for 4Vn, 4Vs, 4W. Dashed lines denote the long-term mean."}
...
pSST_4Vn<-plot_indicator(SST_ind_4Vn, YEAR, SST, y_label= "4Vn SST") 
pSST_4Vs<-plot_indicator(SST_ind_4Vs, YEAR, SST, y_label= "4Vs SST") 
pSST_4W<-plot_indicator(SST_ind_4W, YEAR, SST, y_label= "4W SST") 
 
pbt_4Vn<-plot_indicator(BottomT_ind_4Vn, YEAR, Bottom_Temp, y_label="4Vn Bottom Temp")

pbt_4Vs<-plot_indicator(BottomT_ind_4Vs, YEAR, Bottom_Temp, y_label="4Vs Bottom Temp")

pbt_4W<-plot_indicator(BottomT_ind_4W, YEAR, Bottom_Temp, y_label="4W Bottom Temp") 
...
po2<-plot_indicator(ess_o2_annual, YEAR, mean_data, y_label= "Dissolved oxygen (mmol/L)") 
...
```{r ,fig.align="center", echo = FALSE,fig.pos='H', fig.pos='H', fig.cap="Fishing Pressure (FP) calculated from DFO Summer Research Vessel survey. Data have been corrected for catchability with the exception of invertebrates. Dashed lines denote long-term means, solid green lines denote ± stanard deviation (SD) from the available timeseries. Purple, shaded areas represent the latest 5 years of available, robust data."}
...
```{r, fig.align="center", echo = FALSE, fig.pos='H',fig.height=8, fig.width=10, fig.cap ="Commercial landings (kg) collected from NAFO, ZIF and MARFIS databases for species categories in the ESS. Dashed lines represent the mean, solid green lines denote ± stanard deviation (SD). Purple, shaded areas are the latest 5 years of available data."}
...
```{r, fig.align="center", echo = FALSE, fig.pos='H',fig.cap ="Shrimp Fishing Areas (red lines) and bathymetries for the ESS. Blue lines indicate depth > 75 fathoms (left), Black lines indicate depth > 100 fathoms (right)."}
dat.dir<-here::here("data")
bathy<- "bathy_sf.rda"
coast<-"coast_sf.rda"
...
```{r fig.align="center", echo = FALSE, fig.pos='H', fig.cap="Nitrate 0-50m, Nitrate 50-150, from Louisburg Line (LL), Chlorophyll (surface) from the Eastern Scotian Shelf. Dashed lines represent the mean, solid green lines denote ± stanard deviation (SD). Purple, shaded areas are the latest 5 years of available data. "}
dat.dir<-here::here("data")
...
### Bloom statistics
```{r fig.align="center", echo = FALSE, fig.pos='H',fig.cap="Bloom statistics,for the ESS. Dashed lines representent the mean, solid green lines denote ± stanard deviation (SD) . Purple, shaded areas are the latest 5 years of available data. "}
azmpdata::RemoteSensing_Annual_Broadscale
...
```{r fig.align="center", echo = FALSE,fig.pos='H', fig.cap=" *C.finmarchicus*, and meso zooplankton biomass (dry weight), from NAFO regions within the ESS. Dashed lines represent the mean, solid green lines denote ± stanard deviation (SD). Purple, shaded areas are the latest 5 years of available data. "}
...
pcf4w<-plot_indicator(CF_ind_4W, YEAR, Calanus_finmarchicus, y_label="4W C. finmarchicus")
pzp4v<-plot_indicator(ZP_ind_4V, YEAR, Zooplankton_Biomass, y_label="4V Zooplankton biomass")   
pzp4w<-plot_indicator(ZP_ind_4W, YEAR, Zooplankton_Biomass, y_label="4W Zooplankton biomass")  
...
```{r fig.align="center", echo = FALSE,fig.pos='H',fig.width = 5, fig.height=4, fig.cap="Large fish indicator from RV survey data that has been corrected for catchability. Dashed lines represent the mean, solid green lines denote ± stanard deviation (SD). Purple, shaded areas are the latest 5 years of available data."}
dat.dir<-here::here("data")
eco_indicators<- "eco_indicators_esswss.Rdata"
  load(file.path(dat.dir, eco_indicators))
...
```{r fig.align="center", echo = FALSE, fig.pos='H', fig.height=8, fig.width=10, fig.cap="Total biomass and guild-level biomasses for fish catagories from DFO's Summer RV survey which have been corrected for catchability. Invertebrate estimates are not corrected for catchability. Dashed lines represent the mean, solid green lines denote ± stanard deviation (SD). Purple, shaded areas are the latest 5 years of available data."}
dat.dir<-here::here("data")
eco_indicators<- "eco_indicators_esswss.Rdata"
  load(file.path(dat.dir, eco_indicators))
