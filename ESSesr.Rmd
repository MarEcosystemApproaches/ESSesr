...
```{r, echo = FALSE, fig.align="center", fig.pos='H', fig.cap="Sea Surface Temperature and Bottom temperature from fixed stations for 4Vn, 4Vs, 4W. Dotted lines denote the long-term mean."}
